...
\midrule
Diffusion & 600 & $5.0\!\times\!10^3$ & 3.0M & 22.36 \\
...
Diffusion leads with 22.36 kNN@1, significantly outperforming other methods while using about 3.0M training samples.
Normalizing flows achieve 0.18 kNN@1 after roughly 9.3M samples, suggesting diminishing returns with increased computation relative to diffusion.
The baseline I-JEPA achieves 0.24 kNN@1 with 10.0M samples, while MDN and autoregressive models show lower performance (0.052 and 0.09 kNN@1 respectively) despite efficient training.
...
\begin{itemize}
    \item \textbf{Computational efficiency vs performance.} Diffusion achieves the highest kNN@1 (22.36) with about 3.0M training samples. The baseline I-JEPA reaches 0.24 kNN@1 with 10.0M samples, and the normalizing flow attains 0.18 kNN@1 after roughly 9.3M samples, indicating that diffusion is the most sample-efficient among the tested heads.
...
Diffusion over embeddings performs best (22.36 kNN@1) while using about 3.0M training samples.
The deterministic baseline achieves 0.24 kNN@1 with 10.0M samples, normalizing flows reach 0.18 kNN@1 after roughly 9.3M samples, and lightweight methods (MDN: 0.052 kNN@1, autoregressive: 0.09 kNN@1) underperform despite efficient training.
